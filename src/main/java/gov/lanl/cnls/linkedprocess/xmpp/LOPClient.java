...
public class LOPClient {
    ...
    protected static String SCRIPT_ENGINE_NAME = "JavaScript";
    ...
    public LOPClient() throws Exception {
        ...
        this.connectToServer(xmpp_server, xmpp_port);
        this.initiateFeatures();
        this.loginToServer(username, password);
        System.out.println();

        ScriptEngineManager mgr = new ScriptEngineManager();
        engine = mgr.getEngineByName(SCRIPT_ENGINE_NAME);
        ...
        connection.disconnect(offlinePresence);
    ...
    private void loginToServer(String username, String password) {
        ...
        try {
            ...
            Presence presence = new Presence(Presence.Type.available,
                   "Waiting to process...", 127, Presence.Mode.available);
