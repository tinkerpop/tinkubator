...
public class SmackPlay {
    ...
    private static String username = "linked.process.2@xmpp42.linkedprocess.org";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ConnectionConfiguration connConfig = new ConnectionConfiguration("xmpp42.linkedprocess.org", 5222);
