...
public class MockingTest {
	...
	public void subscribingToAFarmsRosterShouldResultInThreePresencePacketsBack() throws Exception {
		...
		PresenceSubscriptionListener subscriptionListener = (PresenceSubscriptionListener) packetListeners.get(2);
		...
		//subscription acc
		assertEquals(Presence.Type.subscribed, ((Presence)sentPackets.get(0)).getType());
		//subscribe request to the client
		assertEquals(Presence.Type.subscribe, ((Presence)sentPackets.get(1)).getType());
		//Farm status
		assertEquals(Presence.Type.available, ((Presence)sentPackets.get(2)).getType());
		xmppFarm.shutDown();
		
	}
	@Test
	public void checkCorrectStartupAndShutdownPacketsAndListeners() throws Exception {
		...
		assertEquals(2, sentPackets.size());
		//Farm started
		assertEquals(Presence.Type.available, ((Presence)sentPackets.get(0)).getType());
		assertEquals(XmppFarm.STATUS_MESSAGE_STARTING, ((Presence)sentPackets.get(0)).getStatus());
		assertEquals(LinkedProcess.HIGHEST_PRIORITY, ((Presence)sentPackets.get(0)).getPriority());
		//scheduler started
		assertEquals(Presence.Type.available, ((Presence)sentPackets.get(1)).getType());
		assertEquals(XmppFarm.STATUS_MESSAGE, ((Presence)sentPackets.get(1)).getStatus());
		assertEquals(LinkedProcess.HIGHEST_PRIORITY, ((Presence)sentPackets.get(1)).getPriority());
		...
		//scheduler shut down
		assertEquals(Presence.Type.unavailable, ((Presence)sentPackets.get(2)).getType());
		assertEquals(XmppFarm.STATUS_MESSAGE_TERMINATING, ((Presence)sentPackets.get(2)).getStatus());
		assertEquals(LinkedProcess.HIGHEST_PRIORITY, ((Presence)sentPackets.get(2)).getPriority());
		//The Farm terminated
		assertEquals(Presence.Type.unavailable, ((Presence)sentPackets.get(3)).getType());
